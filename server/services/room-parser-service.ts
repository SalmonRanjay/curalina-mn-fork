...
import type { ParsedRoomData } from "@shared/schema";
 ...
 */
export async function parseRoomDescription(description: string): Promise<ParsedRoomData> {
 ...
 */
export function validateParsedRoomData(roomData: ParsedRoomData): string[] {
  const issues: string[] = [];
