...
export async function registerRoutes(app) {
    ...
    app.put('/api/content/:id', isAuthenticated, isAdmin, async (req, res) => {
        try {
            const userId = req.user.id;
            const { id } = req.params;
    ...
    app.get('/api/my-dashboard/stats', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    // Get user's renders
    app.get('/api/my-dashboard/renders', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    app.get('/api/my-dashboard/quiz-responses', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    app.get('/api/my-dashboard/cart', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    // Get user's orders
    app.get('/api/my-dashboard/orders', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    app.get('/api/my-dashboard/orders/:orderId', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    app.get('/api/my-dashboard/saved-designs', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    // Save a design
    app.post('/api/my-dashboard/saved-designs', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    app.patch('/api/my-dashboard/saved-designs/:id', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
            const { id } = req.params;
    ...
    app.delete('/api/my-dashboard/saved-designs/:id', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
            const { id } = req.params;
            const existing = await storage.getSavedDesignById(id, userId);
    ...
    app.get('/api/my-dashboard/is-saved/:renderId', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    app.get('/api/my-dashboard/product-interactions', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
    ...
    app.post('/api/migrate-session-data', isAuthenticated, async (req, res) => {
        try {
            const userId = req.user.id;
