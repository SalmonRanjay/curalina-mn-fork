 ...
 */
export function isFrontViewImage(imagePath) {
    if (!imagePath)
        return false;
 ...
 */
export function findFrontViewImage(images) {
 ...
 */
export function prioritizeFrontViewImage(images) {
    if (!images || images.length === 0)
        return [];
 ...
 */
export function extractFrontViewBatch(productImages) {
    const frontViewMap = new Map();
