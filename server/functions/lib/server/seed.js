...
async function seed() {
    ...
    const roomCategories = [
        { name: "Living Room", type: "room", slug: "living-room" },
        { name: "Bedroom", type: "room", slug: "bedroom" },
        { name: "Dining Room", type: "room", slug: "dining-room" },
        { name: "Office", type: "room", slug: "office" },
        { name: "Kitchen", type: "room", slug: "kitchen" },
    ];
    const furnitureCategories = [
        { name: "Sofa", type: "furniture", slug: "sofa" },
        { name: "Chair", type: "furniture", slug: "chair" },
        { name: "Table", type: "furniture", slug: "table" },
        { name: "Bed", type: "furniture", slug: "bed" },
        { name: "Storage", type: "furniture", slug: "storage" },
        { name: "Lighting", type: "furniture", slug: "lighting" },
        { name: "Decor", type: "furniture", slug: "decor" },
    ];
