 ...
 */
function buildInpaintPrompt(products, stylePreference) {
 ...
 */
export async function generateInpaintRender(params) {
    try {
 ...
 */
export function isInpaintingAvailable() {
    return !!STABILITY_API_KEY;
}
//# sourceMappingURL=stability-inpainting-render.js.map