 ...
 */
function extractAndDecodeS3Key(url) {
    try {
 ...
 */
function fullyDecodeAndNormalize(key) {
    let decoded = key;
    let prev;
 ...
 */
export async function renameAllProductImages(storage, dryRun = false) {
 ...
 */
export async function previewImageRenames(storage) {
    return renameAllProductImages(storage, true);
}
//# sourceMappingURL=s3-image-renamer.js.map