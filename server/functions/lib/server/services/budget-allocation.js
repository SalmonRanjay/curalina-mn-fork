 ...
 */
export function budgetRangeToNumeric(budgetRange) {
 ...
 */
export function calculateBudgetAllocation(roomType, budgetRange) {
    ...
    const categoryBudgets = weights.map(weight => {
 ...
 */
export function mapProductCategoryToBudgetCategory(productCategoryName, roomType) {
 ...
 */
export function calculateBudgetFitScore(productPrice, categoryBudget) {
    if (!categoryBudget) {
 ...
 */
export function calculateProductScoreWithBudget(product, productCategoryName, // Category name (e.g., "Sofa"), not ID
quiz, budgetAllocation, categoryMatchScore, // 0-40
styleMatchScore, // 0-30
visualSimilarityScore // 0-20
) {
 ...
 */
export function validateBudgetCompliance(selectedProducts, budgetAllocation, roomType, categoryMap // Optional: categoryId -> categoryName mapping
) {
...
//# sourceMappingURL=budget-allocation.js.map