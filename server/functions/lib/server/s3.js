 ...
 */
export function validateUpload(buffer, contentType) {
 ...
 */
export function generateProductImageKey(productSku, filename) {
 ...
 */
export async function generatePresignedUploadUrl(key, contentType, maxFileSize = MAX_FILE_SIZE) {
 ...
 * @returns The new key
 */
export async function renameS3Object(oldKey, newKey) {
