...
exports.registerCuralinaRoutes = registerCuralinaRoutes;
...
function registerCuralinaRoutes(app) {
    app.post("/api/curalina/query", localAuth_js_1.isAuthenticated, handleCuralinaQuery);
}
